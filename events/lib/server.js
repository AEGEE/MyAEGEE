...
server.get({ path: '/ping', version: cur_version }, function (req, res, next) {
  res.send('pong'); return next();
});
...
server.put({ path: '/single/:event_id/participants/status/:application_id', version: cur_version },
           events.setApplicationStatus);
server.put({ path: '/single/:event_id/participants/comment/:application_id', version: cur_version },
           events.setApplicationComment);
server.get({ path: '/single/:event_id/participants/mine', version: cur_version },
           events.getApplication);
server.put({ path: '/single/:event_id/participants/mine', version: cur_version },
