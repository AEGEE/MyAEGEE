...
export declare namespace walletobjects_v1 {
    ...
    export class Resource$Walletobjects$V1$Privatecontent {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setPassUpdateNotice(params: Params$Resource$Walletobjects$V1$Privatecontent$Setpassupdatenotice, options: StreamMethodOptions): GaxiosPromise<Readable>;
        setPassUpdateNotice(params?: Params$Resource$Walletobjects$V1$Privatecontent$Setpassupdatenotice, options?: MethodOptions): GaxiosPromise<Schema$SetPassUpdateNoticeResponse>;
