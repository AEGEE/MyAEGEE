...
describe('Events creation', () => {
    ...
    test('should fail if organizing bodies is not set', async () => {
        const data = generator.generateEvent();
        delete data.bodies;
    ...
    test('should fail if organizing bodies is not an array', async () => {
        const res = await request({
            uri: '/',
            method: 'POST',
            headers: { 'X-Auth-Token': 'blablabla' },
    ...
    test('should fail if organizing bodies is an empty array', async () => {
        const res = await request({
            uri: '/',
            method: 'POST',
            headers: { 'X-Auth-Token': 'blablabla' },
    ...
    test('should fail if organizing bodies is malformed', async () => {
        const res = await request({
            uri: '/',
            method: 'POST',
            headers: { 'X-Auth-Token': 'blablabla' },
